...
'''
    ...
    for param in param_list:
        ...
        os.system("ffmpeg -i juemishiming.mp4 -c:v libx264 -b:v 4500k -minrate 4500k -maxrate 4500k -c:a aac -b:a 500k -bufsize 5000k -nal-hrd cbr -muxrate 5000k -vf \"subtitles=input.srt:force_style=force_style='Alignment=2,MarginV=240'\" -streamid 0:0x102 -streamid 1:0x103 " + str(param.input_file))
