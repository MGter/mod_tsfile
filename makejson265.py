...
'''
    ...
    for param in param_list:
        ...
        os.system("ffmpeg -i juemishiming.mp4 -g 25 -r 25 -s 1920x1080 -c:v libx265 -b:v 4000k -minrate 4000k -maxrate 4000k -c:a aac -b:a 500k -bufsize 5000k -nal-hrd cbr -muxrate 5000k -vf \"subtitles=input.srt:force_style=force_style='Alignment=2,MarginV=240'\" -streamid 0:0x100 -streamid 1:0x101 " + str(param.input_file))
